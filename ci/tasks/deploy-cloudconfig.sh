...
OMG_NETWORK_DNS_1=$PCF_MANAGEMENT_DNS
OMG_NETWORK_DNS_2=$PCF_SERVICES_DNS
OMG_NETWORK_DNS_3=$PCF_DEPLOYMENT_DNS

OMG_NETWORK_RESERVED_1=$PCF_MANAGEMENT_RESERVED
OMG_NETWORK_RESERVED_2=$PCF_SERVICES_RESERVED
OMG_NETWORK_RESERVED_3=$PCF_DEPLOYMENT_RESERVED
