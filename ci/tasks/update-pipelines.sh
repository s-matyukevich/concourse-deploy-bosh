...
CONCOURSE_URI=$CONCOURSE_URL CONCOURSE_TARGET=$DEPLOYMENT_NAME BOSH_CLIENT=$bosh_client_id BOSH_CLIENT_SECRET=$bosh_client_secret BOSH_CA_CERT=$bosh_cacert concourse-deploy-rabbitmq/setup-pipeline.sh
